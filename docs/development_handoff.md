...
R031以用户最后的“图像外侧右上角，悬停时覆盖显示”为准。共享媒体入口默认隐藏，图像／图表及工具行悬停或按钮获得键盘焦点时显示；预留工具行保持稳定，不遮图内信息，不随移入移出改变排版。图片单击选中和双击放大保持。完整构建／检查、56个UI目标复查与隔离Typora29项及安装状态见[本轮反馈](feedback_review.md#2026-09-13-esc恢复与媒体悬停入口)。

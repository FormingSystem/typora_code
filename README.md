...
| 更新 | 按GitHub提交hash下载ZIP，无需Git或历史；Windows多窗口启动仅提醒一次，全阶段进度反馈，立即安装、手动重启 |

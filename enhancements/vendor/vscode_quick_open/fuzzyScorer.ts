...
import { createMatches as createFuzzyMatches, fuzzyScore, IMatch, isUpper, matchesPrefix } from 'monaco-editor/base/common/filters.js';
import { hash } from 'monaco-editor/base/common/hash.js';
import { sep } from 'monaco-editor/base/common/path.js';
import { isLinux, isWindows } from 'monaco-editor/base/common/platform.js';
import { equalsIgnoreCase } from 'monaco-editor/base/common/strings.js';

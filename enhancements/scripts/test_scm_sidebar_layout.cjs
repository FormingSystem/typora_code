...
app.whenReady().then(async()=>{
  ...
  await evaluate(String.raw`(()=>{
    ...
    window.panel={subscribe_state(listener){listener();return()=>{};},progress:new layout_qa.git_operation_progress(),root:'layout-fixture',container:document.createElement("div"),branches:[],state:{root:'layout-fixture',head:'',changes:[],refs:[],commits:[],more:false,remotes:[]},settings:{},host:{show_history(){}},refresh(){},configured_menu(){},action_dialog(){},quick_action(){},report(){}};

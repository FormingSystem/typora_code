...
for(const relative of ['install_windows.ps1','check_windows.ps1','cpp_github-consolas.css','cpp_github-consolas_light.css','cpp_github-consolas_dark.css','scripts','enhancements/dist','enhancements/runtime_head.html','enhancements/bundle_markers.txt','enhancements/node_runtime.json','enhancements/release.json'])fs.cpSync(path.join(repository,relative),path.join(checkout,relative),{recursive:true});

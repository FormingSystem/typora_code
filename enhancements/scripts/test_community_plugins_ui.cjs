...
app.whenReady().then(async()=>{
 ...
 await ev(`commands['typora_code:community_plugin_settings']();void 0`);await check('无可配置插件时说明状态','document.querySelector(".workspace-community-setting-list").textContent.includes("没有可配置" )');

...
assert(output.includes('typora-code:workspace'));assert(output.includes('workspace mount timed out'));assert(!output.includes('insertAdjacentHTML("beforeend", `<link'));

...
export function bind_workspace_link_dock(core:graph_core,files:workspace_file_host){
  ...
  const layout=()=>{
    ...
    set('--workspace-preview-width',width+'px');set('--workspace-preview-height',height+'px');

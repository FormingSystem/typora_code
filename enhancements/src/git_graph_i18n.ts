...
const zh_cn = {
  ...
  "settings.label.scm_integration": "SCM 提交图入口位置",
...
const en: Record<git_graph_text_key, string> = {
  ...
  "settings.label.scm_integration": "SCM Git Graph Integration",
...
function language_candidates(): string[] {
  ...
  const plugin_env = (runtime as unknown as Record<PropertyKey, unknown>)[Symbol.for("typora-plugin-core@v2:env")] as {userLang?: string} | undefined;
  return [
    plugin_env?.userLang,

...
export const graph_defaults = {
  ...
  history_always_show_actions: false, auto_center: true, file_view: "tree", compact_folders: true,
...
export function settings_labels_for(locale?: git_graph_locale): Record<keyof graph_settings, string> {
  ...
  return {
    ...
    history_always_show_actions: label("settings.label.history_always_show_actions"), auto_center: label("settings.label.auto_center"), file_view: label("settings.label.file_view"), compact_folders: label("settings.label.compact_folders"), combine_refs: label("settings.label.combine_refs"), uncommitted_style: label("settings.label.uncommitted_style"), inline_markdown: label("settings.label.inline_markdown"),
